...
const parseAttachments = async (body) => {
    ...
    if (typeof body.imageDataUrl === "string" && body.imageDataUrl.trim()) {
        ...
        attachments.imageDescription = await describeImage(body.imageDataUrl, attachments.imageName ?? "image");
    }
...
export const createBattle = async (req, res) => {
    try {
        ...
        const battle = await Battle.create({
            ...
            solution_1_reasoning: turn.solution_1_reasoning,
            solution_2_reasoning: turn.solution_2_reasoning,
            winner: turn.solution_1_score > turn.solution_2_score
                ? "Mistral"
